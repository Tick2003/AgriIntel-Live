...
*   **B2B Marketplace**: "Tinder for Crops" — Matches Farmers with Millers and Exporters.
*   **Fintech Hub**: Generates an **Agri-Credit Score** based on historical yield stability.
...
*   **ML & Math**: XGBoost, Scikit-Learn, Scipy (Linear Programming), NetworkX (Graph Algo).
*   **Data**: SQLite (Optimized with VACUUM), OpenWeatherMap API, Pandas.
